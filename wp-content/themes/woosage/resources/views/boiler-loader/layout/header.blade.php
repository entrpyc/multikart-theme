<header>
  ...
  <div class="top-header">
      <div class="container">
          <div class="flex-row">
              ...
              <div class="flex-col-2 jc-end">
                  <ul class="header-dropdown flex ai-center jc-end">
  ...
  <div class="container">
      <div class="flex-row ">
        <div class="main-menu flex ai-center jc-sb">
            <div class="menu-left flex ai-center">
                <div class="navbar">
                    ...
                    <div id="mySidenav" class="sidenav">
                        <a href="#!" class="sidebar-overlay close-nav"></a>
                        <nav>
                            <div class="close-nav">
                            ...
                            <!-- Vertical Menu -->
                            <ul id="sub-menu" class="nav-wrapper">
                        ...
                        <ul class="flex ai-center">
                            ...
                            <li class="onhover-div mobile-setting">
                                ...
                                <div class="show-div setting">
                                    <h6>language</h6>
                                    <ul>
                                        <li class="flex"><a href="#">english</a> </li>
                                        <li class="flex"><a href="#">french</a> </li>
                                    </ul>
                                    <h6>currency</h6>
                            ...
                            <li class="onhover-div mobile-cart">
                                ...
                                <ul class="show-div shopping-cart">
                                    <li>
                                        <div class="media">
                                            <a href="#"><img class="mr-3"
                                                    src="@asset('images/fashion/product/1.jpg')"
                                    ...
                                    <li>
                                        <div class="media">
                                            <a href="#"><img class="mr-3"
                                                    src="@asset('images/fashion/product/2.jpg')"
                                                    alt="Generic placeholder image"></a>
                                            <div class="media-body">
                                                <a href="#">
                                                    <h4>item name</h4>
                                    ...
                                    <li>
                                        <div class="buttons flex ai-center jc-sb">
