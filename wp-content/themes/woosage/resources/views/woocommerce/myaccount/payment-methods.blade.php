...
@else
	...
	<p class="woocommerce-Message woocommerce-Message--info woocommerce-info">{{ __( 'No saved methods found.', 'woocommerce' ) }}</p>
...
@if ( WC()->payment_gateways->get_available_payment_gateways() )
	<a class="button" href="{{ esc_url( wc_get_endpoint_url( 'add-payment-method' ) ) }}">{{ __( 'Add payment method', 'woocommerce' ) }}</a>
@endif
