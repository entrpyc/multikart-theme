...
<head>
	...
	<title>{{ __( 'Application authentication request', 'woocommerce' ) }}</title>
	@php wp_admin_css( 'install', true ) @endphp
...
<body class="wc-auth wp-core-ui">
	<h1 id="wc-logo"><img src="{{ WC()->plugin_url() }}/assets/images/woocommerce_logo.png" alt="WooCommerce" /></h1>
